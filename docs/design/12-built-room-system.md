...
本文档描述房间**建设完成后**的持续运作逻辑：研究区消耗房间存量产出因子、造物区消耗意志产出权限/信息、生活区提供住房、事务所解锁功能等。数值设计见 [08 - 游戏数值系统](08-game-values.md) 第 6、7 节。

**前置**：房间须经 [11 - 区域建设功能](11-zone-construction.md) 建设完成，`room.zone_type` 已绑定区域类型。
...
- [08 - 游戏数值系统](08-game-values.md)（研究区/造物区产出数值）
- [10 - 房间清理系统](10-room-cleanup-system.md)（清理完成与资源授予边界）
- [11 - 区域建设功能](11-zone-construction.md)（建设流程、资源授予约束 2.6）
